...
hi DiffAdd    cterm=bold ctermbg=DarkGreen gui=none guifg=bg guibg=Red
hi DiffDelete cterm=bold ctermbg=DarkRed gui=none guifg=bg guibg=Red
hi DiffChange cterm=bold ctermbg=DarkBlue gui=none guifg=bg guibg=Red
hi DiffText   cterm=bold ctermbg=DarkYellow gui=none guifg=bg guibg=Red
" vim: sw=2
